...
bool cdr_serialize_serial_motor_demo_msgs__msg__MotorCommand(
  const serial_motor_demo_msgs__msg__MotorCommand * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_serial_motor_demo_msgs
bool cdr_deserialize_serial_motor_demo_msgs__msg__MotorCommand(
  eprosima::fastcdr::Cdr & cdr,
  serial_motor_demo_msgs__msg__MotorCommand * ros_message)
{
  // Field name: is_pwm
  {
    uint8_t tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_serial_motor_demo_msgs
bool cdr_serialize_key_serial_motor_demo_msgs__msg__MotorCommand(
  const serial_motor_demo_msgs__msg__MotorCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: is_pwm
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_serial_motor_demo_msgs
size_t get_serialized_size_key_serial_motor_demo_msgs__msg__MotorCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorCommand__ros_msg_type * ros_message = static_cast<const _MotorCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_serial_motor_demo_msgs
size_t max_serialized_size_key_serial_motor_demo_msgs__msg__MotorCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const serial_motor_demo_msgs__msg__MotorCommand * ros_message = static_cast<const serial_motor_demo_msgs__msg__MotorCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_serial_motor_demo_msgs__msg__MotorCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  serial_motor_demo_msgs__msg__MotorCommand * ros_message = static_cast<serial_motor_demo_msgs__msg__MotorCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_serial_motor_demo_msgs__msg__MotorCommand(cdr, ros_message);
}
